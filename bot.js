                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*🧚 HATA ÇÖZÜMLEME [WHATSASENA] 🧚*' + 
                                        '\n========== ```Hata Okundu!``` ==========' +
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- 🧚ERROR REPORT 🧚[JADUB] --*' + 
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*🧚 ERROR ANALYSIS [JADUB] 🧚*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
