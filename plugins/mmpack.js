...
const Ln = "*᳆𝐀𝐌 𝐁𝐎𝐓 🌸നിങ്ങൾ ആഗ്രഹിക്കുന്ന രീതിയിൽ മെമ്മുകൾ ഇച്ഛാനുസൃതമാക്കാൻ മെമ്മെ ലിസ്റ്റ്* "
 const code = "*᳆𝐀𝐌 𝐁𝐎𝐓 🌸*\n JADUBot🧚\n*❖═List═❖*\n\n*🧚.yasai       ❴your text❵*\n*🧚.uddika    ❴your text❵*\n*🧚.aah          ❴your text❵*\n*🧚.sir            ❴your text❵*\n*🧚.my3         ❴your text❵*\n*🧚.fuck         ❴your text❵*\n*🧚.hii             ❴your text❵*\n*🧚.asai          ❴your text❵*\n*🧚.hapoi       ❴your text❵*\n*╚═══❖══✨══💓══❖═══╝*\n\n*▷Creator: ᳆𝐀𝐌 𝐁𝐎𝐓 🌸*"
...
if (Config.WORKTYPE == 'public') {
    ...
    Asena.addCommand({ pattern: 'my3 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: '🚀Made by *᳆𝐀𝐌 𝐁𝐎𝐓 🌸*' })
...
Asena.addCommand({ pattern: 'fuck ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: '🚀Made by *BICKUSIR*' })
...
Asena.addCommand({ pattern: 'aah ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: '🚀Made by *bicku*' })
