...
const array = ['Hi','King','alive','Bgm','Hlo','Love','Pali','Sad','Song','Neymar','Messi','SFI','Ringtone','paatt','Bot','Allu','Vijay','Bai','Power','Sed','Venda','Manyan','gdnight','Goodmorning','Loveu','Polikkum','Save','Chunk','Va','Kali','Da','Umbi','3g','Avalu','Palkuppi','Gun','Go','Nialle','Ooo','Kannapi','Mood','Africa','Fan','Poda','Life','Cr7','Ronaldo','song','help','Don','goodmorning','Single','Sir','Ameen','Okby','Myr','Angry','Revange','Kasu','img']
array.map( async (a) => {
...
const array = ['Aliya','Ameen','Comady','Da','Enjoy','Hi','Kallan','Manyan','Neymar','Sugham','alive','Don']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
